---
title: "Time to Restore - 2024-2025 data"
...
For the purposes of this report, we focused on observations submitted in the current water year, from 1 October 2024 - 30 September 2025. Throughout this report, we often compared current water-year data with data collected during the previous water year (October 2023 - September 2024).
...
int_no <- filter(status, intensity_NotYes == 1)
  # Two instances (American beautyberry in TX in 2024; butterfly milkweed in TX in 2025)
...
There were `r sum(int_no$wy == 2025)` instances since October 2024 where an observer did not report "yes" for a particular phenohpase, but did report an intensity value.
...
intensitycat_high %>%
  ...
  kable(col.names = c("Species", "Phenophase", "Intensity category", 
                      "Observations", "Plants", "Observations", "Plants"),
        align = c("l", "c", "r", "c", "c", "c", "c")) %>%
  add_header_above(header = c(" " = 3, "2024" = 2, "2025" = 2))
```
...
map_file <- "ttr-sep2025-figs/ttr-2025-map.png"
...
# Create state-level static maps
  ...
  ggsave("ttr-sep2025-figs/LA-map.png",
         la_map,
         height = 6,
         width = (6 * la_ar) + 0.5,
         units = "in",
  ...
  ggsave("ttr-sep2025-figs/NM-map.png",
         nm_map,
         height = 6,
         width = (6 * nm_ar) + 0.5,
         units = "in",
  ...
  ggsave("ttr-sep2025-figs/OK-map.png",
         ok_map,
         height = 6,
         width = (6 * ok_ar) + 0.5,
         units = "in",
  ...
  ggsave("ttr-sep2025-figs/TX-map.png",
         tx_map,
         height = 6,
         width = (6 * tx_ar) + 0.5,
         units = "in",
...
```{r}
#| label: fig-state4
#| fig-cap: Locations of sites where priority species were monitored between October 2024 and September 2025. 
#| echo: false
#| fig.width: 8

knitr::include_graphics("ttr-sep2025-figs/ttr-2025-map.png")
```

```{r}
#| label: fig-la
#| fig-cap: Locations of sites in Louisiana where priority species were monitored between October 2024 and September 2025. 
#| echo: false
#| fig.width: 10

knitr::include_graphics("ttr-sep2025-figs/LA-map.png")
```

```{r}
#| label: fig-nm
#| fig-cap: Locations of sites in New Mexico where priority species were monitored between October 2024 and September 2025. 
#| echo: false
#| fig.width: 10

knitr::include_graphics("ttr-sep2025-figs/NM-map.png")
```

```{r}
#| label: fig-ok
#| fig-cap: Locations of sites in Oklahoma where priority species were monitored between October 2024 and September 2025. 
#| echo: false
#| fig.width: 10

knitr::include_graphics("ttr-sep2025-figs/OK-map.png")
```

```{r}
#| label: fig-tx
#| fig-cap: Locations of sites in Texas where priority species were monitored between October 2024 and September 2025. 
#| echo: false
#| fig.width: 10

knitr::include_graphics("ttr-sep2025-figs/TX-map.png")
```

```{r}
#| label: tbl-sites
#| tbl-cap: Summary of sites monitored in each state from October 2024 to September 2025. Here, an observation is all data collected for a plant on a given date.
#| echo: false
...
```{r}
#| label: tbl-plants
#| tbl-cap: Summary of plants monitored from October 2024 to September 2025. Here, an observation is all data collected for a plant on a given date.
#| echo: false
...
hist1_file <- "ttr-sep2025-figs/ttr-2025-spp-per-observer.png"
...
hist2_file <- "ttr-sep2025-figs/ttr-2025-plants-per-spp.png"
...
```{r}
#| label: tbl-observer
#| tbl-cap: Summary of people who submitted data for priority species between October 2024 and September 2025, by state. Values in table are means, with range of values in parentheses.
#| echo: false
...
#| fig-cap: Number of species each observer monitored between October 2024 and September 2025.
#| echo: false
#| fig.height: 3
#| fig.width: 8
...
#| fig-cap: Number of plants per species that observers monitored between October 2024 and September 2025.
#| echo: false
#| fig.height: 3
#| fig.width: 8
...
To evaluate observation frequency, we downloaded individual phenometrics data for priority species from 1 October 2023 through 30 September 2025.
...
if (!file.exists(ip_filename) | update_data == TRUE) {
  ...
  # Download flowering, fruiting data for Oct 2024 - Sep 2025 and Oct 2023 - 
...
#| fig-cap: Proportion of first "yes" observations that were associated with a prior "no" with a given number of days, grouped by phenophase. 2024 = October 2023 - September 2024. 2025 = October 2024 - September 2025.
#| echo: false
#| fig.height: 5
#| fig.width: 10
...
#| fig-cap: Proportion of first "yes" observations that were associated with a prior "no" with a given number of days, grouped by species. We excluded species with fewer than 20 "yes" observations in both water years. 2024 = October 2023 - September 2024. 2025 = October 2024 - September 2025.
#| echo: false
#| fig.height: 5
#| fig.width: 10

...
map <- magick::image_read("ttr-2025-figs/ttr-2025-map.png") %>%
...
la_map <- magick::image_read("ttr-2025-figs/LA-map.png") %>%
  magick::image_ggplot(interpolate = TRUE)
la_map
```
...
nm_map <- magick::image_read("ttr-2025-figs/NM-map.png") %>%
  magick::image_ggplot(interpolate = TRUE)
nm_map
```
...
ok_map <- magick::image_read("ttr-2025-figs/OK-map.png") %>%
  magick::image_ggplot(interpolate = TRUE)
ok_map
```
...
tx_map <- magick::image_read("ttr-2025-figs/TX-map.png") %>%
  magick::image_ggplot(interpolate = TRUE)
tx_map
```
